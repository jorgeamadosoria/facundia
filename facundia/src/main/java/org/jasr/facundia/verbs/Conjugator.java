...
//		forms.put(Verb.INF, new VerbForm(Verb.INF,"(.*)->1"));
//
//		forms.put(Verb.GER,
//				new VerbForm(Verb.GER,"poder->pudiendo", "ir->yendo", "evertir->everto", "rendir->rindiendo", "(.*)ar->1,ando",
//						"(.*)(a|o|e)(e|í)r->1,2,yendo", "(.*)ll(i|e)r->1,llendo", "(.*)er->1,iendo",
//						"(.*)(m|p)edir->1,2,idiendo", "(.*)e(nch|rt|rgu|gu|m|nt|b|st|g|c|n|t|r|rv)ir->1,i,2,iendo",
//						"(.*)o(r|rm)ir->1,u,2,iendo", "(.*)uir->1,uyendo", "(.*)ir->1,iendo"));
//
//		forms.put(Verb.PART,
//				new VerbForm(Verb.PART,"romper->roto", "ver->visto", "(pre|entre|ante)ver->1,visto", "(.*)ar->1,ado",
...
//						"(.*)decir->1,ito", "(.*)brir->1,bierto", "(.*)ír->1,ído", "(.*)(e|i)r->1,ido"));
		...
		forms.put(Verb.PRES_IND_YO, new VerbForm(Verb.PRES_IND_YO,"hendir->hiendo", "rendir->rindo", "rehundir->rehúndo",
				...
				"(.*)(a|e)izar->1,2,ízo", "(.*)(a|e|i)r->1,o"));

//		forms.put(Verb.PRES_IND_TU,
//				new VerbForm(Verb.PRES_IND_TU,forms.get(Verb.PRES_IND_YO), "ser->eres", "remecer->remeces", "mecer->meces",
...
//				new VerbForm(Verb.PRES_IND_VOSEO,"haber->ir", "(.*)(i|í)r->1,ís", "(.*)er->1,és", "mr:(.*)ar->1,ás"));
//
//		forms.put(Verb.PRES_IND_VOS,
//				new VerbForm(Verb.PRES_IND_VOS,forms.get(Verb.PRES_IND_VOSEO), "mr:(.*)uir->1,is", "(.*)(a|á|e|é)s->1,2,is", "(.*)->1"));

//		forms.put(Verb.PRES_IND_EL, forms.get(Verb.PRES_IND_TU));
//
//		forms.put(Verb.PRES_IND_NOSOTROS, new VerbForm(Verb.PRES_IND_NOSOTROS,"ser->somos", "haber->hemos", "ir->vamos", "(.*)r->1,mos"));
//
//		forms.put(Verb.PRES_IND_USTEDES, new VerbForm(Verb.PRES_IND_USTEDES,forms.get(Verb.PRES_IND_EL), "ser->son", "(.*)->1,n"));
//
//		forms.put(Verb.PRES_IND_ELLOS, forms.get(Verb.PRES_IND_USTEDES));
//
//		forms.put(Verb.COP_IND_YO,
//				new VerbForm(Verb.COP_IND_YO,"ser->era", "ir->iba", "(.*)ar->1,aba", "(.*)ver->1,veía", "(.*)(e|i)r->1,ía"));
//
//		forms.put(Verb.COP_IND_TU, new VerbForm(Verb.COP_IND_TU,forms.get(Verb.COP_IND_YO), "(.*)->1,s"));
//
//		forms.put(Verb.COP_IND_EL, forms.get(Verb.COP_IND_YO));
//
//		forms.put(Verb.COP_IND_NOSOTROS,
//				new VerbForm(Verb.COP_IND_NOSOTROS,forms.get(Verb.COP_IND_YO), "ser->éramos", "ir->fuéramos", "(.*)aba->1,ábamos", "(.*)->1,mos"));
//
//		forms.put(Verb.COP_IND_VOS, new VerbForm(Verb.COP_IND_VOS,forms.get(Verb.COP_IND_YO), "(.*)->1,is"));
//
//		forms.put(Verb.COP_IND_ELLOS, new VerbForm(Verb.COP_IND_ELLOS,forms.get(Verb.COP_IND_YO), "(.*)->1,n"));
//
//		forms.put(Verb.PRET_IND_YO,
//				new VerbForm(Verb.PRET_IND_YO,"dar->di", "andar->anduve", "desandar->desanduve", "ser->fui", "ver->vi", "caber->quepo",
//						"haber->hube", "contrahacer->contrahíce", "ir->fui", "(.*)gar->1,gué", "(.*)guar->1,güé",
//						"(.*)zar->1,cé", "(.*)car->1,qué", "mr:(.*)ar->é", "(.*)ducir->1,duje", "(.*)ecir->1,ije",
//						"(.*)venir->1,vine", "mr:(.*)ir->1,í", "(.*)tener->1,tuve", "(.*)saber->1,supe", "(.*)poder->1,pude",
//						"(.*)poner->1,puse", "(.*)traer->1,traje", "(.*)querer->1,quise", "(.*)(h|f)acer->1,2,ice",
//						"(.*)er->í"));
//
//		forms.put(Verb.PRET_IND_TU,
//				new VerbForm(Verb.PRET_IND_TU,forms.get(Verb.PRET_IND_YO), "contrahacer->contrahiciste", "(.*)(a|e|o)í->1,2,íste",
...
//
//		forms.put(Verb.PRET_IND_VOS, new VerbForm(Verb.PRET_IND_VOS,forms.get(Verb.PRET_IND_TU), "(.*)->1,is"));
//
//		forms.put(Verb.PRET_IND_EL,
//				new VerbForm(Verb.PRET_IND_EL,forms.get(Verb.PRET_IND_TU), "(ser|ir)->fue", "rendir->rindió", "contrahacer->contrahízo",
...
//
//		forms.put(Verb.PRET_IND_NOSOTROS, new VerbForm(Verb.PRET_IND_NOSOTROS,forms.get(Verb.PRET_IND_TU), "(.*)ste->1,mos"));
//
//		forms.put(Verb.PRET_IND_USTEDES, new VerbForm(
//				Verb.PRET_IND_USTEDES,
//				Rules.r("ser->fueron"), Rules.r("ir->fueron"), Rules.r("desdar->desdieron"),
//				Rules.r("(.*)venir->1,vinieron"),
//				Rules.r(forms.get(Verb.PRET_IND_EL), "(.*)o", new String[] { "mr:(.*)ar"},
//						new String[] { "1", "aron" }),
//				Rules.r(forms.get(Verb.PRET_IND_EL), "(.*)o", new String[] {"(.*)ar" },
//						new String[] { "1", "ieron" }),
//				Rules.r(forms.get(Verb.PRET_IND_EL), "(.*)ó", new String[] { "(.*)ar" },
//						new String[] { "1", "aron" }),
//				Rules.r(forms.get(Verb.PRET_IND_EL), "(.*)ó", new String[] { "(.*)ir" },
//						new String[] { "1", "eron" }),
//				Rules.r(forms.get(Verb.PRET_IND_EL), "(.*)o", new String[] { "(.*)ir" },
//						new String[] { "1", "eron" }),
//				Rules.r(forms.get(Verb.PRET_IND_EL), "(.*)o", new String[] { "(.*)er" },
//						new String[] { "1", "ieron" }),
//				Rules.r(forms.get(Verb.PRET_IND_EL), "(.*)jo", new String[] { "(.*)er" },
//						new String[] { "1", "jeron" }),
//				Rules.r(forms.get(Verb.PRET_IND_EL), "(.*)ó", new String[] { "(.*)er" },
//						new String[] { "1", "eron" })));
//
//		forms.put(Verb.PRET_IND_ELLOS, forms.get(Verb.PRET_IND_USTEDES));
//
//		forms.put(Verb.FUT_IND_YO,
//				new VerbForm(Verb.FUT_IND_YO,"ir->é", "bendecir->bendeciré", "maldecir->maldeciré", "(.*)(ten|pon|val)er->1,2,dré",
//						"(.*)(ha|fa)cer->1,2,ré", "(.*)(pod|quer|sab|cab|hab)er->1,2,ré", "(.*)(sal|ven)ir->1,2,dré",
//						"(.*)decir->1,diré", "(.*)ír->1,iré", "(.*)->1,é"));
//
//		forms.put(Verb.FUT_IND_TU, new VerbForm(Verb.FUT_IND_TU,forms.get(Verb.FUT_IND_YO), "(.*)é->1,ás"));
//
//		forms.put(Verb.FUT_IND_VOS, new VerbForm(Verb.FUT_IND_VOS,forms.get(Verb.FUT_IND_YO), "(.*)->1,is"));
//
//		forms.put(Verb.FUT_IND_EL, new VerbForm(Verb.FUT_IND_EL, forms.get(Verb.FUT_IND_YO), "(.*)é->1,á"));
//
//		forms.put(Verb.FUT_IND_NOSOTROS, new VerbForm(Verb.FUT_IND_NOSOTROS,forms.get(Verb.FUT_IND_YO), "(.*)é->1,emos"));
//
//		forms.put(Verb.FUT_IND_ELLOS, new VerbForm(Verb.FUT_IND_ELLOS,forms.get(Verb.FUT_IND_EL), "(.*)->1,n"));
//
//		forms.put(Verb.POS_IND_YO, new VerbForm(Verb.POS_IND_YO,"(.*)ar->1,ía", "(.*)(ten|pon|val|po)er->1,2,dría",
//				"(.*)querer->1,querría", "(.*)(h|f)acer->1,2,ría", "(.*)(c|h|s)aber->1,2,abría", "(.*)er->1,ía",
//				"(.*)(ven|sal)ir->1,2,dría", "(.*)decir->1,diría", "(.*)enserir->1,enseriaría", "(.*)ir->1,ía"));

//		forms.put(Verb.POS_IND_TU, new VerbForm(Verb.POS_IND_TU,forms.get(Verb.POS_IND_YO), "(.*)->1,s"));

//		forms.put(Verb.POS_IND_VOSEO, forms.get(Verb.POS_IND_TU));

//		forms.put(Verb.POS_IND_VOS, new VerbForm(Verb.POS_IND_VOS,forms.get(Verb.POS_IND_YO), "(.*)ía->1,íais"));

//		forms.put(Verb.POS_IND_EL, forms.get(Verb.POS_IND_YO));

//		forms.put(Verb.POS_IND_NOSOTROS, new VerbForm(Verb.POS_IND_NOSOTROS,forms.get(Verb.POS_IND_YO), "(.*)->1,mos"));

//		forms.put(Verb.POS_IND_USTEDES, forms.get(Verb.PRET_IND_ELLOS));

//		forms.put(Verb.POS_IND_ELLOS, new VerbForm(Verb.POS_IND_ELLOS, forms.get(Verb.POS_IND_YO), "(.*)->1,n"));

		forms.put(Verb.PRES_SUB_YO,
				new VerbForm(Verb.PRES_SUB_YO,forms.get(Verb.PRES_IND_YO), Rules.r("ser->sea"), Rules.r("ir->vaya"),
						Rules.r("enserir->enserie"), Rules.r("(.*)oy->1,é"), Rules.r("(.*)go->1,gue"),
						Rules.r("(.*)zo->1,ce"), Rules.r("(.*)co->1,que"), Rules.r("(.*)guo->1,güe"),
						Rules.r("(.*)o", new String[] {"(.*)ar"}, new String[] { "1", "e" }),
						Rules.r("(.*)o", new String[] { "(.*)(e|i)r" }, new String[] { "1", "a" }),
						Rules.r("(.*)->1,n")));

//		forms.put(Verb.PRES_SUB_TU, new VerbForm(Verb.PRES_SUB_TU,forms.get(Verb.PRES_SUB_YO), "dar->des", "(.*)s->1"));

//		forms.put(Verb.PRES_SUB_NOSOTROS,
//				new VerbForm(Verb.PRES_SUB_NOSOTROS,"ser->seamos", "haber->habramos", "caber->quepamos", "desvaír->desvayamos", "ir->vayamos",
...
//		forms.put(Verb.PRES_SUB_VOS, new VerbForm(Verb.PRES_SUB_VOS,"dar->deis", "ir->vayáis", "desleír->desliáis", "desvaír->desvayáis",
...
//		forms.put(Verb.PRES_SUB_USTEDES, new VerbForm(Verb.PRES_SUB_USTEDES,forms.get(Verb.PRES_SUB_YO), "dar->den", "(.*)s->1,n"));

//		forms.put(Verb.PRES_SUB_ELLOS, forms.get(Verb.PRES_SUB_USTEDES));

//		forms.put(Verb.FUT_SUB_YO, new VerbForm(Verb.FUT_SUB_YO,forms.get(Verb.PRET_IND_YO), "ser->fuere", "ir->fuere",
...
//
//		forms.put(Verb.FUT_SUB_TU, new VerbForm(Verb.FUT_SUB_TU, forms.get(Verb.FUT_SUB_YO), "(.*)->1,s"));
//		
//		forms.put(Verb.FUT_SUB_NOSOTROS,
//				new VerbForm(Verb.FUT_SUB_NOSOTROS,forms.get(Verb.FUT_SUB_YO), "(.*)ere->1,éremos", "(.*)are->1,áremos"));
//
//		forms.put(Verb.FUT_SUB_VOS, new VerbForm(Verb.FUT_SUB_VOS,forms.get(Verb.FUT_SUB_YO), "(.*)->1,is"));
//
//		forms.put(Verb.FUT_SUB_ELLOS, new VerbForm(Verb.FUT_SUB_ELLOS,forms.get(Verb.FUT_SUB_YO), "(.*)->1,n"));
//
//		forms.put(Verb.CO_SUB_YO, new VerbForm(Verb.CO_SUB_YO,forms.get(Verb.FUT_SUB_YO), "(.*)e->1,a"));
//
//		forms.put(Verb.CO_SUB_TU, new VerbForm(Verb.CO_SUB_TU,forms.get(Verb.CO_SUB_YO), "(.*)->1,s"));
//
//		forms.put(Verb.CO_SUB_EL, forms.get(Verb.CO_SUB_YO));

//		forms.put(Verb.CO_SUB_NOSOTROS, forms.get(Verb.CO_SUB_NOSOTROS));

//		forms.put(Verb.FUT_SUB_NOSOTROS, new VerbForm(Verb.FUT_SUB_NOSOTROS,"(.*)emos->1,amos"));

//		forms.put(Verb.CO_SUB_VOS, new VerbForm(Verb.CO_SUB_VOS, forms.get(Verb.CO_SUB_YO), "(.*)->1,is"));
//
//		forms.put(Verb.CO_SUB_ELLOS, new VerbForm(Verb.CO_SUB_ELLOS,forms.get(Verb.CO_SUB_YO), "(.*)->1,n"));
//
//		forms.put(Verb.PRES_IMP_TU,
//				new VerbForm(Verb.PRES_IMP_TU,forms.get(Verb.PRES_IND_TU), "ser->sé", "dar->da", "haber->he", "(.*)ener->1,én",
//						"(.*)oner->1,ón", "(.*)cer->1,az", "mr:(.*)decir->1,dí", "mr:(.*)venir->1,vén",
//						"(.*)salir->1,sal", "(.*)s->1"));
//
//		forms.put(Verb.PRES_IMP_VOSEO, new VerbForm(Verb.PRES_IMP_VOSEO, "ir->andá", "mr:(.*)r->1"));
//
//		forms.put(Verb.PRES_IMP_USTED, forms.get(Verb.PRES_SUB_YO));
//
//		forms.put(Verb.PRES_IMP_VOS, new VerbForm(Verb.PRES_IMP_VOS,"(.*)r->1,d"));
//
//		forms.put(Verb.PRES_IMP_USTEDES, new VerbForm(Verb.PRES_IMP_USTEDES,forms.get(Verb.PRES_IMP_USTED), "(.*)->1,n"));

	}
	
	public String conjugate(String infinitive,Verb form) {
	...
	public Map<Verb, String> conjugate(String infinitive) {
		return forms.keySet().stream()
				...
				return forms.get(key).conjugate(infinitive);
				}));
	}
}
